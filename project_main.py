...
print("\nWelcome to Discover-Athlete database!\n")
...
while True:
    ...
    print('7. Important Insights into Discover-Athlete')
    ...
    if option_1=="1":
        ...
        print('4. Display Coach who has produced maximum high performing players')
        print('5. Display upcoming Amateur athlete')
        print('6. Display athlete with highest paid brand endorsement for a particular brand')
        ...
        if opt=='1':
            ...
            connection.begin()
            print("Displaying the coach who has produced maximum number of players from one team ")
            execute9.callproc('cpm')
